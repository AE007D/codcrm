...
const navItems: NavItem[] = [
  ...
  { labelKey: "nav_orders", href: "/commandes", agentVisible: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2"/>
      <rect x="9" y="3" width="6" height="4" rx="1"/><path d="M9 12h6M9 16h4"/>
    </svg>
  )},
  { labelKey: "nav_payments", href: "/paiements", agentVisible: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M12 2v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/>
    </svg>
  )},
  { labelKey: "nav_checkouts", href: "/funnels", agentVisible: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M22 3H2l8 9.46V19l4 2v-8.54L22 3z"/>
    </svg>
  )},
  { labelKey: "nav_clients", href: "/clients", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/>
      <circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/>
    </svg>
  )},
  { labelKey: "nav_products", href: "/produits", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/>
      <path d="M16 10a4 4 0 01-8 0"/>
    </svg>
  )},
  { labelKey: "nav_boutiques", href: "/boutiques", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/>
      <polyline points="9 22 9 12 15 12 15 22"/>
    </svg>
  )},
  { labelKey: "nav_team", href: "/equipe", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/>
      <path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/>
    </svg>
  )},
  { labelKey: "nav_finances", href: "/finances", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/>
    </svg>
  )},
  { labelKey: "nav_calculator", href: "/calculateur", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
  ...
  { labelKey: "nav_ameex", href: "/ameex", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
  ...
  { labelKey: "nav_ads", href: "/ads", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M22 12h-4l-3 9L9 3l-3 9H2"/>
    </svg>
  )},
  { labelKey: "nav_whatsapp", href: "/whatsapp", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"/>
    </svg>
  )},
  { labelKey: "nav_telegram", href: "/telegram", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M21.5 4.5L2.5 10.5l7 2m12-8L17 21.5l-7.5-9m12-8l-10 7"/>
    </svg>
  )},
  { labelKey: "nav_integrations", href: "/integrations", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/>
      <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/>
    </svg>
  )},
  { labelKey: "nav_reports", href: "/rapports", adminOnly: true, icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen(o => !o)}
        className="hamburger-btn lg:hidden fixed top-3.5 left-3.5 z-[60] w-9 h-9 bg-white rounded-xl shadow-md border border-slate-100 flex items-center justify-center text-slate-600 hover:bg-slate-50 transition-colors"
        aria-label="Menu"
      >
        {open ? (
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
      ...
      {/* Sidebar panel */}
      <aside className={`
        sidebar-panel fixed lg:static inset-y-0 left-0 z-[58]
        w-72 lg:w-64 h-full lg:h-auto
        bg-white border-r border-slate-100 flex flex-col shrink-0 shadow-sm
        transition-transform duration-200 ease-in-out
        ${open ? "translate-x-0" : "sidebar-closed -translate-x-full lg:translate-x-0"}
      `}>
        <div className="px-4 py-4 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={notifRef}>
              ...
              {/* Dropdown */}
              {showNotifDropdown && (
                <div className="absolute top-11 left-0 w-80 max-w-[calc(100vw-2rem)] bg-white rounded-2xl shadow-xl border border-slate-100 z-[100] overflow-hidden">
                  <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between">
                    <span className="text-sm font-bold text-slate-900">{t("notifications")}</span>
                    {notifTotal === 0 && <span className="text-xs text-slate-400">{t("all_up_to_date")}</span>}
                    {notifTotal > 0 && <span className="text-xs font-semibold text-red-500">{notifTotal} {t("n_pending")}</span>}
                  </div>
                      ...
                      <div>
                        ...
                        {nouveauOrders.length > 5 && (
                          <Link href="/commandes" onClick={() => setShowNotifDropdown(false)}
                            ...
                            +{nouveauOrders.length - 5} {t("view_all_orders").replace("→", "").trim()} →
                          </Link>
                        )}
                      </div>
                    )}
                      ...
                      <div>
                        ...
                        {confirmedOrders.length > 5 && (
                          <Link href="/commandes" onClick={() => setShowNotifDropdown(false)}
                            ...
                            +{confirmedOrders.length - 5} {t("view_all_orders").replace("→", "").trim()} →
                          </Link>
                        )}
                      </div>
                    )}
        ...
        <nav className="flex flex-col gap-0.5 p-3 flex-1 overflow-y-auto">
          <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider px-3 mb-2 mt-1">{t("menu")}</p>
        ...
        <div className="p-3 border-t border-slate-100">
          {/* Language picker */}
          <div className="flex items-center gap-1 mb-1 px-3 py-1.5">
